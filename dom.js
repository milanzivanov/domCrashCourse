...
// itemList.parentNode.style.backgroundColor = "indianred";
...
// add class
// newDiv.className = "hello div class";
// add id
// newDiv.id = "helloId";
...
// create text node
// var newDivText = document.createTextNode('Zravo!!!');
...
function runEvent(e) {
    ...
    // output.innerHTML = '<h4>MouseX: ' + e.offsetX + '</h4><h3>MouseY: ' + e.offsetY + '</h3>';
